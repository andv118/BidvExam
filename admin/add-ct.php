                ...
                <form class='form-material form-horizontal' style="width: 100%;">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" id="mact" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12" for="example-text">Tên ca thi</label>
                            <div class="col-md-12">
                                <input type="text" id="tenct" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" id="gc" class="form-control mydatepicker" >
                            </div>
                        </div>
                    </div>
                </form>
