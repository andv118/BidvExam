    ...
    <script type="text/javascript">
        $(document).ready(function(e){
            $("#cathi").change(function(e){
                // alert($("#cathi").text());
                window.location="decentralization.php?select_r_c_exam_chosse="+$(this).val()+"&select_r_c_exam_chosse_name="+$(this).find("option:selected").text();
            });
