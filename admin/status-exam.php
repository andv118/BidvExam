    ...
    <script type="text/javascript">
        $(document).ready(function(e){
            $("#cathi").change(function(e){
                // alert($("#cathi").text());
                window.location="status-exam.php?select_r_c_exam_chosse="+$(this).val()+"&select_r_c_exam_chosse_name="+$(this).find("option:selected").text();
            });
            ...
            $("#phongthi, #monthi").change(function(e){
                ...
                $.ajax({
                    type:'POST',
                    url:'sql/status-exam-sql.php',
                    data:{phongthi:pt, monthi:mt},
                    success: function(e){
                        $("#load").html(e);
                        $(".preloader").hide();
                    }
